(function wireNextGuideButton(step) {
    step && step.attachEvent(step.guideElement[0], 'click', function(e) {
        ...
        if (advanceButton.length) {
            ...
            // Use the below code to trigger another guide on the same page where this guide is targeted.
            ...
            // Uncomment below lines to build your own dynamic permalink URL by using the metadata variable.
            ...
            // var newurl = "https://" + account_name + ".app.com/?pendo=your_pendo_guide_id"
