// This customization is designed to let the guide container "collapse" and move up above the fold and out of the way.
...
(function (dom) {
    var offset = '-519.5px' // ***EDIT THIS VALUE BASED ON HOW FAR LEFT THE GUIDE NEEDS TO MOVE***
  ...
  if (sessionStorage.pendoCollapseStatus === "collapse") {
    guideContainer.style.right = offset;
  ...
  dom(".pendo-expand-collapse-button").on("click", function () {
    if (sessionStorage.pendoCollapseStatus === "collapse") {
      guideContainer.style.right = "0px";
